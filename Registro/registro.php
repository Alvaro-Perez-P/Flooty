...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $passwConf = isset($_POST["passwConf"]) ? $_POST["passwConf"] : "";
    $rol = $_POST["rol"];
    $telf = $_POST["telefono"];
    ...
    if($email == ""){
        ...
        $err_email = "El email no tiene un formato valido";
        $errores = true;
    }
    ...
    if($telf == ""){
        $err_telf = "Introduce un telefono";
        $errores = true;
    }

    if($direc == ""){
        $err_direc = "Introduce una direccion";
        $errores = true;
    }

    if($passw == ""){
        $err_passw = "Introduce una contrasena";
        $errores = true;
    }elseif(strlen($passw) < 6){
        $err_passw = "La contrasena debe tener al menos 6 caracteres";
        $errores = true;
    }

    if($passwConf == ""){
        $err_passwConf = "Confirma tu contrasena";
        $errores = true;
    }elseif($passwConf !== $passw){
        $err_passwConf = "Las contrasenas no coinciden";
        $errores = true;
    }
        ...
        <div class="caja-formulario">
            ...
            <form method="post">
                ...
                <div class="grupo-input">
                    ...
                    <?php if(isset($err_telf)) echo "<div class='mensaje-error'>$err_telf</div>"; ?>
                </div>

                <div class="grupo-input">
                    <label>Dirección</label>
                    <input type="text" name="direccion">
                    <?php if(isset($err_direc)) echo "<div class='mensaje-error'>$err_direc</div>"; ?>
                </div>

                <div class="grupo-input">
                    <label>Nombre</label>
                    <input type="text" name="nombre">
                    <?php if(isset($err_nombre)) echo "<div class='mensaje-error'>$err_nombre</div>"; ?>
                </div>

                <div class="grupo-input">
                    <label>Contraseña</label>
                    <input type="password" name="passw">
                    <?php if(isset($err_passw)) echo "<div class='mensaje-error'>$err_passw</div>"; ?>
                </div>

                <div class="grupo-input">
                    <label>Confirmar Contraseña</label>
                    <input type="password" name="passwConf">
                    <?php if(isset($err_passwConf)) echo "<div class='mensaje-error'>$err_passwConf</div>"; ?>
                </div>
